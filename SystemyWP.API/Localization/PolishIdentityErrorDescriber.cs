...
namespace Systemywp.Api.Localization
{
    public class PolishIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError {Code = nameof(DefaultError), Description = $"Wystąpił błąd."};
        }
        ...
        {
            return new IdentityError {Code = nameof(InvalidToken), Description = "Niepoprawny token."};
        }
        ...
        {
            return new IdentityError {Code = nameof(InvalidEmail), Description = $"Email '{email}' jest niepoprawny."};
        }

        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError
                {Code = nameof(DuplicateUserName), Description = $"Nazwa '{userName}' jest już zajęta."};
        }
        ...
        {
            return new IdentityError
                {Code = nameof(PasswordTooShort), Description = $"Hasło musi mieć przynajmniej 10 znaków."};
        }
        ...
        public override IdentityError PasswordRequiresUpper()
        {
            return new IdentityError
            {
                ...
                Description = "Hasło musi zawierać przynajmniej jedną dużą literę ('A'-'Z')."
            };
        }
    }
}