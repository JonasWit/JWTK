    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LegalAccessKeys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserEmail = table.Column<string>(type: "character varying(70)", maxLength: 70, nullable: true),
                    UserName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    UserId = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantAccessKeys", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "LegalAppBillingRecords",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LegalAccessKeyId = table.Column<int>(type: "integer", nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedBy = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LegalAppBillingRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LegalAppBillingRecords_LegalAccessKeys_LegalAccessKeyId",
                        column: x => x.LegalAccessKeyId,
                        principalTable: "LegalAccessKeys",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LegalAppClients_LegalAccessKeys_LegalAccessKeyId",
                        column: x => x.LegalAccessKeyId,
                        principalTable: "LegalAccessKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LegalAppReminders_LegalAccessKeys_LegalAccessKeyId",
                        column: x => x.LegalAccessKeyId,
                        principalTable: "LegalAccessKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantAppMenus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantAppMenus_RestaurantAccessKeys_RestaurantAccessKey~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LegalAccessKeyId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_LegalAccessKeys_LegalAccessKeyId",
                        column: x => x.LegalAccessKeyId,
                        principalTable: "LegalAccessKeys",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Users_RestaurantAccessKeys_RestaurantAccessKeyId",
                        column: x => x.RestaurantAccessKeyId,
                        principalTable: "RestaurantAccessKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LegalAppDataAccesses_LegalAccessKeys_LegalAccessKeyId",
                        column: x => x.LegalAccessKeyId,
                        principalTable: "LegalAccessKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "RestaurantAppDataAccesses",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantAppDataAccesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantAppDataAccesses_RestaurantAccessKeys_RestaurantAc~",
                        column: x => x.RestaurantAccessKeyId,
                        principalTable: "RestaurantAccessKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantAppDataAccesses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LegalAppBillingRecords_LegalAccessKeyId",
                table: "LegalAppBillingRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantAppDataAccesses_ItemId",
                table: "RestaurantAppDataAccesses",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantAppDataAccesses_RestaurantAccessKeyId",
                table: "RestaurantAppDataAccesses",
                column: "RestaurantAccessKeyId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantAppDataAccesses_UserId",
                table: "RestaurantAppDataAccesses",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantAppMenus_RestaurantAccessKeyId",
