...
export default {
  ...
  fetch() {
    ...
    this.form.details = this.eventForAction.details;
    ...
    async saveChanges() {
      try {
        const newReminder = {
          ...
          start: new Date(this.submittableDateStart).toISOString(),
          end: new Date(this.submittableDateEnd).toISOString(),
        ...
        await this.$axios.$put(updateNote(clientId, noteId), newReminder);
