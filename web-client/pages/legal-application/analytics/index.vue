    ...
    <template v-slot:content>
      <v-row class="mt-9 mb-9 d-flex ">
        <v-col cols="4">
          ...
          <div>
            Strona prezentująca statystyki jest aktualnie w budowie. Pracujemy na czymś naprawdę wyjątkowym! Już
            niedługo
            powiadomimy stałych użytkowników o nowych funkcjonalnościach aplikacji.
          </div>
