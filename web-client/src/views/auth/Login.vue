      ...
      <div>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <input id="accept-rules" name="accept-rules" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
            <label for="accept-rules" class="ml-2 block text-sm text-gray-900">
              Remember me
            </label>
          </div>
...
import { setTokenCookie} from "@/appControl/controlFunctions";

export default {
  name: "Login",
  setup() {
    const Login = () => { setTokenCookie("test token")}
