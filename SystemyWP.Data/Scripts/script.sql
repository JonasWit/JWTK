...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20210802064423_init') THEN
...
BEGIN
    ...
    CREATE TABLE "PortalPublications" (
        ...
        "News" character varying(10000) NOT NULL,
        "Image" text NULL,
...
BEGIN
    ...
    VALUES ('20210802064423_init', '5.0.8');
    END IF;
END $$;
COMMIT;
