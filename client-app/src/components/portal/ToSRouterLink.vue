<template>
  <router-link :to="{ 'name': 'ToS' }" class="px-4 flex justify-end border-r-4"
               :class="{ 'border-customClassicBlue': $route.path === '/tos',  'border-white': $route.path !== '/tos'}">
    <span class="inline-flex items-center">Regulamin</span>
